...
$.fn.jQuerySimpleCounter = function( options ) {
 ...
 if ($(this).scrollTop() >= $("#projectFacts").position().top && seEjecuto === 0) {
 	seEjecuto = 1;
  $('#number1').jQuerySimpleCounter({start: 0,end: 150,duration: 4000});
  $('#number2').jQuerySimpleCounter({start: 0,end: 30,duration: 4000});
  $('#number3').jQuerySimpleCounter({start: 0,end: 5,duration: 4000});
  $('#number4').jQuerySimpleCounter({start: 0,end: 8,duration: 4500});
}
});
    </script>
