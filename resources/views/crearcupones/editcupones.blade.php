                ...
                <div class="empresa-form">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <select name="categoria_id" id="categoria_id" class="empresa_input">
                                @foreach ($categoriasEdit as $categorias)
                                    <option value="{{ $categorias->id }}" @if ($cupones->categoria_id == $categorias->id) selected @endif
                                        class="empresa_input">{{ $categorias->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="fechaInicio" value="{{ $cupones->fechaInicio }}"
