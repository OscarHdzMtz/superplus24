...
<div class="container border border-primary">
    ...
    <div class="text-center row justify-content-md-center">
        <div class="col-md-offset col-md-6">
            {!! Form::open([
            'route' => ['crearPublicidad.update', $getPublicidadEditar->id],
            'method' => 'PATCH',
            'files' => 'true',
            ]) !!}
            {{ Form::token() }}
                    ...
                    {{-- <div class="mx-auto text-center card" style="width: 400px;"> --}}
                        {{-- <div class="form-group">
                            ...
                            <select name="categoria_id" id="categoria_id" class="empresa_input">
                                ...
                                <option value="{{$categoriasEdit->id}}" @if ($getPublicidadEditar->categoria_id ==
                                    $categoriasEdit->id) selected @endif class="empresa_input">{{$categoriasEdit->name}}
                                </option>
                                @endforeach
                            </select>
                        </div> --}}
                        ...
                        <div class="form-group cold-md-6">
                            ...
                            <img src="{{ asset('/img/publicidadEmergente/' . $getPublicidadEditar->image) }}"
                                alt="{{ $getPublicidadEditar->titulo }}" height="300px" width="50px"
                                class="card-img-top">
                            @endif
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                {{-- <div class="col">
                                    <label for="visible">Prioridad</label><input type="checkbox" name="prioridad" {{
                                        $getPublicidadEditar->prioridad == 1 ? "checked='checked'" : ''}}>
                                </div> --}}
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" name="textoDelBoton" class="empresa_input" value={{
                                        $getPublicidadEditar->textoDelBoton }}>
                                </div>
                                <div class="col">
                                    <label for="visible">Redireccionar a: <small>(Opcional)</small></label> <br>
                                    <input type="text" name="paginaARedireccionar" class="empresa_input" value={{
                                        $getPublicidadEditar->paginaARedireccionar }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="fechaInicio" value="{{ $getPublicidadEditar->fechaInicio }}"
                                class="empresa_input"> <br>
                            <label>Fecha Fin</label>
                            <input type="date" name="fechaFin" value="{{ $getPublicidadEditar->fechaFin }}"
                                class="empresa_input">
                        </div>
                        <div class="form-group">
