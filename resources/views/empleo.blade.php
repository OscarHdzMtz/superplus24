            ...
            <div id="carouselExampleSlidesOnly" class="banner_nosotros" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        @php $webpEmpleoBanner = \Illuminate\Support\Str::slug(pathinfo($setempleo->image, PATHINFO_FILENAME)) . '.webp'; @endphp
                    ...
                    <div class="row ">
                        <div class="col-lg-4">
                            <div class="service-img">
                                @php $webpEmpleoImage = \Illuminate\Support\Str::slug(pathinfo($setempleo->image, PATHINFO_FILENAME)) . '.webp'; @endphp
...
@section('cards')
    ...
    <div style="margin-bottom: 50px" data-aos="fade-up" class="container_vacan">
        @foreach ($addvacante as $setvacante)
            <div class="card">
                <div class="img-cover">
                    @php $webpVacante = \Illuminate\Support\Str::slug(pathinfo($setvacante->image, PATHINFO_FILENAME)) . '.webp'; @endphp
