        ...
        >   
            ...
            <form class="border-b border-slate-200">
                <div class="relative">
                    ...
                    <input id="modal-search" class="w-full py-3 pl-10 pr-4 border-0 appearance-none focus:ring-transparent placeholder-slate-400" type="search" placeholder="Search Anything…" x-ref="searchInput" />
                    <button class="absolute inset-0 right-auto group" type="submit" aria-label="Search">
                        <svg class="w-4 h-4 ml-4 mr-2 fill-current shrink-0 text-slate-400 group-hover:text-slate-500" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="px-2 py-4">
                ...
                <div class="mb-3 last:mb-0">
                    <div class="px-2 mb-2 text-xs font-semibold uppercase text-slate-400">Recent searches</div>
                    <ul class="text-sm">
                        <li>
                            <a class="flex items-center p-2 rounded text-slate-800 hover:text-white hover:bg-indigo-500 group" href="#0" @click="searchOpen = false" @focus="searchOpen = true" @focusout="searchOpen = false">
                                <svg class="w-4 h-4 mr-3 fill-current text-slate-400 group-hover:text-white group-hover:text-opacity-50 shrink-0" viewBox="0 0 16 16">
                ...
                <!-- Recent pages -->
                <div class="mb-3 last:mb-0">
                    <div class="px-2 mb-2 text-xs font-semibold uppercase text-slate-400">Recent pages</div>
                    <ul class="text-sm">
                        <li>
                            <a class="flex items-center p-2 rounded text-slate-800 hover:text-white hover:bg-indigo-500 group" href="#0" @click="searchOpen = false" @focus="searchOpen = true" @focusout="searchOpen = false">
                                <svg class="w-4 h-4 mr-3 fill-current text-slate-400 group-hover:text-white group-hover:text-opacity-50 shrink-0" viewBox="0 0 16 16">
