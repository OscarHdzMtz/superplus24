<div class="modal fade" id="modalCookie" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div
            ...
            <i class="fas fa-cookie-bite fa-3x mb-3" style="color: #ffcc00;"></i>
            <span class="mt-2">Este sitio web almacena cookies para habilitar la funcionalidad del sitio con el fin de ofrecerle una mejor
